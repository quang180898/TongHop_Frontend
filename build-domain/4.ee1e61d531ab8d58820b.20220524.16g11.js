...
// EXTERNAL MODULE: ./node_modules/antd/es/pagination/index.js + 16 modules
var pagination = __webpack_require__(457);

// CONCATENATED MODULE: ./src/components/base/Pagination/PaginationBase.js
...
var PaginationBase_PaginationBase = function PaginationBase(_ref) {
  var _ref$className = _ref.className,
      className = _ref$className === void 0 ? "m_pager" : _ref$className,
      ...
      itemRenderProp = _ref.itemRenderProp,
  ...
  var onHide = function onHide(totalPage) {
    var doc = document.getElementsByClassName("ant-pagination-item");
    var total = totalPage - page;
    ...
    if (doc.length == 6) {
      ...
      if (doc.length == 7) {
        ...
        for (var _i2 = 0; _i2 < doc.length; _i2++) {
          doc[_i2].hidden = false;
        }
      }
    }
  };
  ...
  var itemRender = function itemRender(current, type, originalElement) {
    if (type === 'prev') {
      return /*#__PURE__*/react_default.a.createElement("a", null, "Trang tr\u01B0\u1EDBc");
    }

    if (type === 'next') {
      return /*#__PURE__*/react_default.a.createElement("a", null, "Trang k\u1EBF");
    }
  ...
  var onChangePage = function onChangePage(pageNumber) {
  ...
  return /*#__PURE__*/react_default.a.createElement("div", {
    ...
    className: className // defaultCurrent={page}
    ,
    pageSize: state.limit,
    current: state.page,
    onChange: handlePageChange // showTotal={showTotal ? (total, range) => `${range[0]} tới ${range[1]} của ${total} mục` : ''}
    ,
...
/* harmony default export */ var Pagination_PaginationBase = (PaginationBase_PaginationBase);
// CONCATENATED MODULE: ./src/components/base/Pagination/index.js
...
// CONCATENATED MODULE: ./src/templates/Main/Search/Search.js
...
var Search_Search = function Search() {
  ...
  var listLocation = history.location.pathname.split("/");

  var _React$useState = react_default.a.useState(""),
      _React$useState2 = slicedToArray_default()(_React$useState, 2),
      dataSearch = _React$useState2[0],
      setDataSearch = _React$useState2[1];
  ...
  react_default.a.useEffect(function () {
    if (listLocation.length > 0) {
      ...
      if (history.location.pathname.indexOf("search") != -1) {
        ...
        _dataSearch = paramsSearch.get("q");
      }
  ...
  var onSearch = function onSearch(e) {
    if (e.key === "Enter") {
      e.preventDefault();
      history.replace({
        pathname: contant["b" /* PAGES_URL */].search.url,
  ...
  return /*#__PURE__*/react_default.a.createElement("div", {
    ...
    className: "heading-search text-center"
  }, /*#__PURE__*/react_default.a.createElement("h1", null, "T\xECm ki\u1EBFm")), /*#__PURE__*/react_default.a.createElement("div", {
    className: "search-list"
  }, /*#__PURE__*/react_default.a.createElement("div", {
    className: "search-content"
  }, /*#__PURE__*/react_default.a.createElement("div", {
    className: "empty-search"
  }, /*#__PURE__*/react_default.a.createElement("h2", null, "Kh\xF4ng t\xECm th\u1EA5y n\u1ED9i dung b\u1EA1n y\xEAu c\u1EA7u"), /*#__PURE__*/react_default.a.createElement("div", {
    className: "subtext"
  }, /*#__PURE__*/react_default.a.createElement("span", null, "Kh\xF4ng t\xECm th\u1EA5y k\u1EBFt qu\u1EA3 n\xE0o cho", " ", "\"".concat(dataSearch, "\""), ".")), /*#__PURE__*/react_default.a.createElement("div", {
    className: "empty-search__action"
  }, /*#__PURE__*/react_default.a.createElement("input", {
    type: "text",
    placeholder: "T\xECm ki\u1EBFm to\xE0n b\u1ED9 s\u1EA3n ph\u1EA9m",
    onKeyDown: onSearch
  }))))))))));
};

/* harmony default export */ var Main_Search_Search = __webpack_exports__["default"] = (Search_Search);
